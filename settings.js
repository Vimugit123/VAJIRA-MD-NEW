...
global.owner = process.env.OWNER_NUMBER  || '94772884694' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=eZ9WxbBZ#LsUdRgLzPcfvakajku6TlhQ1_heTfwz4Ea-tykyVymg' ,
